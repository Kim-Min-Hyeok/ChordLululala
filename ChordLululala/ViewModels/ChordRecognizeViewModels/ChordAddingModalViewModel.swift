...
final class ChordAddingModalViewModel: ObservableObject {
    ...
    func isValidChord(_ text: String) -> Bool {
        ...
        let patterns: [String:String] = [
                    // major
                   "maj":    #"^[A-G](?:#|b)?(?:maj)?(?:(?:(?:add2|add4|add9|9|6|#11|13|b5|#5|b9|#9)))*(?:/(?:[A-G](?:#|b)?))?$"#,
                   "maj7":   #"^[A-G](?:#|b)?maj7(?:(?:add2|add4|add9|9|#11|13))*(?:/(?:[A-G](?:#|b)?))?$"#,
                   
                   //7th
                   "seven":  #"^[A-G](?:#|b)?7(?:(?:(?:add2|add4|add9|9|11|13|b5|#5|b9|#9|#11|b13|13)))*(?:/(?:[A-G](?:#|♭)?))?$"#,
